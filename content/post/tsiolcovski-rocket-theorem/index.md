...
高校物理においてよく扱われる運動は**等速直線運動**や**等加速度運動**です。

これらの運動の加速度$a$はどの様になっているのか考察してみましょう。

運動方程式$F=ma$を考えてみましょう。
...
さらに、地球上であれば、実は落ちるものが何であっても$F\propto m$が成り立つことが知られており、これが重力加速度$g$ですね。
...
あえて言葉にするならば、**等力運動**とでもいえば良いのでしょうか。とはいえ、今回は$m$が$t$の一次関数でしたが、これが違えば$a$や$v$も違ってきますので別に用語を作るほどのことでもないでしょう。
