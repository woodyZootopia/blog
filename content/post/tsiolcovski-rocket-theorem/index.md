...
これらの運動の加速度$a$はどのようになっているのか考察してみましょう。
...
### 等加速度運動
**$a$が一定**のときに起こります。$F\propto m$ということですね。

例えば、物が自由落下している間、$F$も$m$も変わらないのでこれは等加速度運動です。

さらに、地球上であれば、実は落ちるものが何であっても$F\propto m$が成り立つことが知られており、その比$\frac{F}{m}$が重力加速度（定数）$g$ですね。
...
であり、**$a$は$t$によって変化します**。これを時間で積分して速度$v$としたので、$\log$が出てきたというわけです。
